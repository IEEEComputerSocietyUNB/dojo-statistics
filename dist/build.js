...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/yurick/github/dojo-statistics/app/App.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-119a3f84", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-119a3f84", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (_vm.searchProp),
	      expression: "searchProp"
	    }],
	    attrs: {
	      "type": "text"
	    },
	    domProps: {
	      "value": _vm._s(_vm.searchProp)
	    },
	    on: {
	      "input": function($event) {
	        if ($event.target.composing) { return; }
	        _vm.searchProp = $event.target.value
	      }
	    }
	  }), _vm._v(" "), _c('presence-list', {
	    attrs: {
	      "students": _vm._f("searchParams")(_vm.students, _vm.searchProp)
	    }
	  })], 1)
	},staticRenderFns: []}
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-119a3f84", module.exports)
	  }
	}
